    ...
    <header>
      ...
      <div className="item right">
        <ul>
          <li>
            <Link to={CART_PAGE}>
              {/* <img src="../../icons/shopping-cart-svgrepo-com.svg" alt="Cart" /> */}
              {/* Cart */}
              <svg
                version="1.1"
                id="Layer_1"
              ...
              >
                <g>
                  <g>
                    <path
                      d="M381.206,216.8c-2.016-2.208-4.875-3.467-7.872-3.467h-42.667h-320c-2.997,0-5.856,1.259-7.872,3.477
			...
			h-11.509l19.392-213.333h21.248L343.136,438.293z"
                ...
                <g>
                  <g>
                    <path
                      d="M245.334,256c-5.899,0-10.667,4.779-10.667,10.667c0,35.296-28.704,64-64,64s-64-28.704-64-64
			...
			S256,313.717,256,266.667C256,260.779,251.232,256,245.334,256z"
                ...
                <g>
                  <g>
                    <path
                      d="M469.312,415.339L447.979,74.005C447.627,68.384,442.966,64,437.334,64h-32c0-35.296-28.704-64-64-64
          ...
          <li>
            <Link to={LOGIN_PAGE}>
              {/* <img src="../../icons/user-profile-icon.svg" alt="Login" /> */}
              {/* Login */}
              <svg
